...
corresponding to the module name "com.acme.corp.tracker" (each "." is replaced with a path separator).
This subdirectory contains two files "acme-subsystem.jar" and "module.xml".
